...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            $table->boolean('google2fa_enforce_globally')->default(false)->after('google2fa_enabled_at');
        });
    }
    ...
    {
        Schema::table('users', function (Blueprint $table) {
            $table->dropColumn(['google2fa_secret', 'google2fa_enabled', 'google2fa_enabled_at', 'google2fa_enforce_globally']);
        });
    }
};
